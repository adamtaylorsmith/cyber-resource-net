  ...
  return ( 
    <div className='bg-neutral-800 h-full'>
      ...
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 mb-2 text-md leading-relaxed">
        <a href="https://www.snort.org/" target="_blank" rel="noreferrer" className="text-blue-300 hover:text-green-400 ">Snort - Intrusion Detection System</a>
      </div>
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 mb-2 text-md leading-relaxed">
        <a href="https://wazuh.com/" target="_blank" rel="noreferrer" className="text-neutral-300 hover:text-green-400 ">Wazuh Open Source SIEM</a>
      </div>
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 mb-2 text-md leading-relaxed">
        <a href="https://suricata.io/" target="_blank" rel="noreferrer" className="text-blue-300 hover:text-green-400 ">Suricata Network Analysis and Threat Detection Software</a>
      </div>
      ...
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-2 text-md leading-relaxed">
        <a href="https://www.snort.org/" target="_blank" rel="noreferrer" className="text-neutral-300 hover:text-green-400 ">Snort - Intrusion Detection System</a>
      </div>
    </div>
  )
}
