  ...
  return (
    <>
      <div className=''>
        ...
        <div className="mx-8 md:mx-14 lg:mx-48 xl:mx-80 mb-2 text-md text-neutral-300 leading-relaxed">
          This collection was built while developing a <span className=" text-neutral-200">home laboratory</span> and working towards the following Cybersecurity technical certifications;<br/><br/><span className=" text-blue-300">CompTIA Network+</span><br/><span className=" text-green-400">CompTIA Security+</span><br/><span className=" text-blue-300">Google Cybersecurity Analyst</span>
        </div>
