...
{/* ****************************************************************************************************************************** */}
        ...
        <div className="py-1.5 flex-row flex flex-nowrap">
            ...
            w-1/2 bg-slate-800 hover:bg-slate-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://www.tcpdump.org/manpages/tcpdump.1.html"><span className='text-lg font-semibold text-zinc-200'>Tcpdump</span>&nbsp;__ packet analyzer</a>

            <a href={TcpdumpTwo} target="_blank" rel="noreferrer" className="px-4 py-3 ml-1.5 w-1/6 md:w-1/5 rounded bg-slate-800 hover:bg-slate-700 text-sm leading-relaxed text-zinc-200 hover:text-zinc-300">
            ...
            <a href={TcpdumpThree} target="_blank" rel="noreferrer" className="px-4 pb-3 pt-3 ml-1.5 w-1/6 md:w-1/5 mr-10 md:mr-14 lg:mr-48 xl:mr-72 rounded bg-slate-800 hover:bg-slate-700 text-sm leading-relaxed text-zinc-200 hover:text-zinc-300">
              <div className='flex-row flex pt-1'>
        ...
        <div className="py-1.5 flex-row flex flex-nowrap mb-12">
            <a className="rounded px-4 md:px-6 py-3 
            ml-10 md:ml-14 lg:ml-48 xl:ml-72 
            w-2/3 bg-slate-800 hover:bg-slate-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://github.com/virustotal/yara"><span className='text-lg font-semibold text-zinc-200'>Yara</span>&nbsp;__ identify and classify malware samples</a>
...
{/* ****************************************************************************************************************************** */}
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-semibold text-blue-400'>__ IDS and SIEM Applications:</h1>
        ...
        <div className="py-1.5">
          <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 text-base leading-relaxed rounded bg-gray-800 hover:bg-gray-700 text-zinc-200 hover:text-zinc-300 flex" target="_blank" rel="noreferrer" href="https://www.snort.org/#documents"><span className='text-lg font-semibold text-orange-100 hover:text-orange-200'>Snort</span>&nbsp;__ intrusion detection system</a>
        </div>

        <div className="py-1.5 flex-row flex flex-nowrap">
            <a className="rounded px-4 md:px-6 py-3 
            ml-10 md:ml-14 lg:ml-48 xl:ml-72 
            w-1/2 bg-slate-800 hover:bg-slate-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://docs.splunk.com/Documentation"><span className='text-lg font-semibold text-red-200 hover:text-red-300'>Splunk</span>&nbsp;__ SIEM</a>
...
{/* ****************************************************************************************************************************** */}
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 text-base leading-relaxed rounded bg-slate-800 hover:bg-slate-700 text-zinc-200 hover:text-zinc-300 flex" target="_blank" rel="noreferrer" href="https://github.com/angryip/ipscan"><span className='text-lg font-semibold text-red-200 hover:text-red-300'>Angry IP</span>&nbsp;__ network scanner</a>
      </div>
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 text-base leading-relaxed rounded bg-slate-800 hover:bg-slate-700 text-zinc-200 hover:text-zinc-300 flex" target="_blank" rel="noreferrer" href="https://github.com/ffuf/ffuf"><span className='text-lg font-semibold text-red-200 hover:text-red-300'>Ffuf</span>&nbsp;__ web fuzzer</a>
      </div>
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 text-base leading-relaxed rounded bg-gray-800 hover:bg-gray-700 text-zinc-200 hover:text-zinc-300 flex" target="_blank" rel="noreferrer" href="https://github.com/laramies/theHarvester"><span className='text-lg font-semibold text-red-200 hover:text-red-300'>TheHarvester</span>&nbsp;__ OSINT emails, subdomains and names harvester</a>
      </div>
