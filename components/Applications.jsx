    ...
    <div className='bg-zinc-900 h-full'>
      ...
      <h1 className="mt-0 mb-16 flex justify-center text-green-400 text-xl md:text-2xl font-bold mx-4 font-mono">Cybersecurity Applications Official Docs</h1>
        ...
        <div className="py-1.5 flex-row flex flex-nowrap">
            ...
            w-1/2 bg-zinc-800 hover:bg-zinc-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://www.tcpdump.org/manpages/tcpdump.1.html"><span className='text-base font-medium text-zinc-200'>Tcpdump</span>&nbsp;__ packet analyzer</a>
        ...
        <div className="py-1.5 flex-row flex flex-nowrap">
            <a className="rounded px-4 md:px-6 py-3 
            ml-10 md:ml-14 lg:ml-48 xl:ml-72 
            w-2/3 bg-neutral-800 hover:bg-zinc-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://www.wireshark.org/docs/wsug_html/"><span className='text-base font-medium text-zinc-300'>Wireshark</span>&nbsp;__ packet sniffer</a>
        ...
        <div className="py-1.5 flex-row flex flex-nowrap mb-12">
            <a className="rounded px-4 md:px-6 py-3 
            ml-10 md:ml-14 lg:ml-48 xl:ml-72 
            w-2/3 bg-zinc-800 hover:bg-zinc-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://github.com/virustotal/yara"><span className='text-base font-medium text-zinc-200'>Yara</span>&nbsp;__ identify and classify malware samples</a>
...
{/* ****************************************************************************************************************************** */}
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>Coding Applications:</h1>
...
{/* ****************************************************************************************************************************** */}
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>IDS and SIEM Applications:</h1>
        ...
        <div className="py-1.5 flex-row flex flex-nowrap">
            <a className="rounded px-4 md:px-6 py-3 
            ml-10 md:ml-14 lg:ml-48 xl:ml-72 
            w-1/2 bg-zinc-800 hover:bg-zinc-700 text-base leading-relaxed text-zinc-200 hover:text-zinc-300" target="_blank" rel="noreferrer" href="https://docs.splunk.com/Documentation"><span className='text-base font-medium text-zinc-200 hover:text-zinc-300'>Splunk</span>&nbsp;__ SIEM</a>
...
{/* ****************************************************************************************************************************** */}
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>Pentesting Applications:</h1>
