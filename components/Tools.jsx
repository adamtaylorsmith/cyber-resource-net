...
const Tools = () => {
  ...
  return (
    <div className='bg-zinc-900 h-full'>
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>Analysis Tools:</h1>
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 leading-relaxed rounded bg-neutral-800 hover:bg-zinc-700 hover:text-zinc-300 flex font-medium text-zinc-200 text-base" target="_blank" rel="noreferrer" href="https://crt.sh/">Crt.sh Certificate Search</a>
      </div>
      <div className="py-1.5">
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 leading-relaxed rounded bg-neutral-800 hover:bg-zinc-700 hover:text-zinc-300 flex font-medium text-zinc-200 text-base" target="_blank" rel="noreferrer" href="https://www.calculator.net/ip-subnet-calculator.html">IP Subnet Calculator</a>
      </div>
...
{/* ****************************************************************************************************************************** */}
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>Incident and Response Tools:</h1>
...
{/* ****************************************************************************************************************************** */}
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>Pentesting Tools:</h1>
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 leading-relaxed rounded bg-neutral-800 hover:bg-zinc-700 hover:text-zinc-300 flex font-medium text-zinc-200 text-base" target="_blank" rel="noreferrer" href="https://www.base64decode.org/">Decode and Encode</a>
      </div>
      <div className="py-1.5">
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 leading-relaxed rounded bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-zinc-400 flex font-medium" target="_blank" rel="noreferrer" href="https://osintframework.com/"><span className='text-base font-medium text-zinc-300'>OSINT Framework</span></a>
      </div>
      <div className="py-1.5">
      ...
      <h1 className='mx-10 md:mx-14 lg:mx-48 xl:mx-72 pb-4 leading-relaxed text-xl font-medium text-blue-300'>Vulnerability Tools:</h1>
      ...
      <div className="py-1.5">
        <a className="px-4 md:px-6 mx-10 md:mx-14 lg:mx-48 xl:mx-72 py-3 leading-relaxed rounded bg-neutral-800 hover:bg-zinc-700 hover:text-zinc-300 flex font-medium text-zinc-200 text-base" target="_blank" rel="noreferrer" href="https://haveibeenpwned.com/">Have I Been Pwned?</a>
      </div>
      <div className="py-1.5">
