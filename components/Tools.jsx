...
{/* ****************************************************************************************************************************** */}
      <h2 className='xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-3 text-md leading-relaxed text-xl font-bold text-green-600'>Analysis and Vulnerabilities:</h2>
...
{/* ****************************************************************************************************************************** */}
      <h2 className='xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-3 text-md leading-relaxed text-xl font-bold text-green-600 pt-6'>TO DO:</h2>
      ...
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-3 text-md leading-relaxed">
        <a href="https://explainshell.com/" target="_blank" rel="noreferrer" className="text-blue-300 hover:text-green-400  ">Explain Shell</a>
      </div>
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-3 text-md leading-relaxed">
        <a href="https://www.cybermission.tech/" target="_blank" rel="noreferrer" className="text-neutral-300 hover:text-green-400  ">DoD Elite Cyber Game</a>
      </div>

      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-3 text-md leading-relaxed">
        <a href="https://cyberchef.org/" target="_blank" rel="noreferrer" className="text-blue-300 hover:text-green-400  ">Cyber Chef</a>
      </div>
