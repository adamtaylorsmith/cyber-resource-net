...
const Resources = () => {
  return (
    <div className='bg-neutral-800 h-full'>
      ...
      <div className="xl:mx-80 lg:mx-60 md:mx-16 mx-10 pb-3 text-md leading-relaxed">
        <a href="https://cloud.google.com/chronicle/docs/overview" target="_blank" rel="noreferrer" className="text-blue-300 hover:text-green-400 ">Google Chronicle SIEM overview</a>
      </div>
    </div>
  )
}
