...
{/* ****************************************************************************************************************************** */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://github.com/Cloud-Architekt/AzureAD-Attack-Defense" target="_blank" rel="noreferrer" className=" text-zinc-300 hover:text-blue-500 ">Azure Active Directory Attack and Defend</a>
      </div> */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.cisco.com/c/en/us/solutions/enterprise/design-zone-security/landing_safe.html" target="_blank" rel="noreferrer" className=" text-zinc-300 hover:text-blue-500 ">Cisco SAFE - Secure Architecture for Everyone </a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href={Control} target="_blank" rel="noreferrer" className=" text-blue-200 hover:text-blue-500 ">Control Categories</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.sans.org/blog/cybersecurity-podcast-roundup/" target="_blank" rel="noreferrer" className=" text-zinc-300 hover:text-blue-500 ">Cybersecurity Podcasts</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href={Glossary} target="_blank" rel="noreferrer" className=" text-zinc-300 hover:text-blue-500 ">Google Cybersecurity Glossary (.pdf)</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://staysafeonline.org/resources/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">NCA Stay Safe Online</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://media.defense.gov/2023/Feb/22/2003165170/-1/-1/0/CSI_BEST_PRACTICES_FOR_SECURING_YOUR_HOME_NETWORK.PDF" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">NSA Best Practices for Securing Your Home Network (.pdf)</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.malware-traffic-analysis.net/index.html" target="_blank" rel="noreferrer" className=" text-zinc-300 hover:text-blue-500 ">Packet Capture files and Malware Samples</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://phishingquiz.withgoogle.com/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Phishing Quiz from Google</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
...
{/* ***************************************************************************************************************************88 */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://generatedata.com/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Generate Test Data</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://docs.python.org/3/library/functions.html" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Python Built-in Functions</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.pythoncheatsheet.org/cheatsheet/basics" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Python Cheatsheet</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
...
{/* ****************************************************************************************************************************** */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href={IncidentHandbook} target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">SANS Incident Handlers Handbook (.pdf)</a>
      </div>
...
{/* ***************************************************************************************************************************88 */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.nist.gov/cyberframework/assessment-auditing-resources" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">NIST Assessment and Auditing Resources</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://pages.nist.gov/800-63-FAQ/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">NIST Digital Identity Guidelines</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href={Incident} target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">NIST Incident Handling Guide (.pdf)</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href={RiskAssessment} target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">NIST Performing Risk Assessments - SP 800-30 (.pdf)</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
...
{/* ****************************************************************************************************************************** */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.cisecurity.org/" target="_blank" rel="noreferrer" className=" text-zinc-300 hover:text-blue-500 ">Center For Internet Security</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://cloudsecurityalliance.org/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Cloud Security Alliance</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xhtml" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Service Name and Transport Protocol Port Number Registry</a>
      </div>
       <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.ncsc.gov.uk/collection/cloud/understanding-cloud-services/cloud-security-shared-responsibility-model" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">UK Cloud Security Guide</a>
      </div>
...
{/* ****************************************************************************************************************************** */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://talosintelligence.com/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Cisco Talos Threat Intelligence</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.exploit-db.com/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Exploit Database</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://gtfobins.github.io/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">GTFOBins - Bypass local security restrictions in misconfigured systems</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://github.com/center-for-threat-informed-defense/adversary_emulation_library" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Library of adversary emulation plans</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://attack.mitre.org/" target="_blank" rel="noreferrer" className="text-blue-200 hover:text-blue-500 ">MITRE ATT&CK knowledge base of adversary tactics and techniques</a><a href="https://attack.mitre.org/matrices/enterprise/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">&nbsp;(2)</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://engage.mitre.org/matrix/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">MITRE Engage Matrix</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href={Pasta} target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">PASTA Threat Modeling</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://unifiedkillchain.com/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Unified Kill Chain - Threat Modeling</a>
      </div>
...
{/* ****************************************************************************************************************************** */}
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xhtml" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Apple Security Releases</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.cisa.gov/known-exploited-vulnerabilities-catalog" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">CISA Known Exploited Vulnerabilities Catalog</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://cwe.mitre.org/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Most Dangerous software and hardware weaknesses</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
      ...
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
        <a href="https://www.exploit-db.com/" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-blue-500 ">Security Bulletins - Google Cloud</a>
      </div>
      <div className="mx-10 md:mx-14 lg:mx-48 xl:mx-80 pb-3 text-base leading-relaxed">
